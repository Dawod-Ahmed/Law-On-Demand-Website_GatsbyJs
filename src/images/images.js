...
export { default as AppEducation } from "./img/aduapp.png";
export { default as AppStoreBtn } from "./img/appstorebtn.png";
export { default as GoogleStoreBtn } from "./img/googlestorebtn.png";
